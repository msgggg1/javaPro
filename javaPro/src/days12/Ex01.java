...
public class Ex01 {
	...
	public static void main(String[] args) throws IOException {
		...
		do {
			...
			if (leng == cnt) {
				names = Arrays.copyOf(names, leng +3);
				kors = Arrays.copyOf(kors, leng +3);
				engs = Arrays.copyOf(engs, leng +3);
				mats = Arrays.copyOf(mats, leng +3);
				tots = Arrays.copyOf(tots, leng +3);
				ranks = Arrays.copyOf(ranks, leng +3);
				avgs = Arrays.copyOf(avgs, leng +3);
