...
//타이브레이크 선택(x,전체 세트, 마지막 세트만), 타이브레이크 점수 선택
...
class ScoreBoard implements Serializable {
    ...
    public ScoreBoard(Player p1, Player p2,
        ...
        this.tieBreakPoints = tieBreakPoints;  // ★ 추가
...
//                  //player2.resetPoints();
    ...
    private void checkTieBreakWin(Player scorer, Player opponent) {
        ...
        int requiredPoints = tieBreakPoints;
...
public class tennis {
    ...
    public static void main(String[] args) throws IOException, ClassNotFoundException {
        ...
        while (true) {
            ...
            if (loadOption.equals("네") || loadOption.equals("아니오")) break;
