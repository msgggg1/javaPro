...
public class Ex03_03 {
	...
	public static void main(String[] args) {
		...
		// 성별로 분할
		Map<Boolean, List<Student>> map = Stream.of(stuArr).collect(Collectors.partitioningBy(Student::isMale)); //s -> s.isMale / 필드 아니고 메서드임
		//true 그룹
...
//		femaleStudent.size();
		...
		// 3. 성별 분할(구분) 후 각 1등 학생의 정보 출력. 
		Map<Boolean, Optional<Student>> map3 = Stream.of(stuArr).collect(Collectors.partitioningBy(Student::isMale, Collectors.maxBy(Comparator.comparing(Student::getScore))));
